...
using CanariasBlog.Areas.CMSCore.Entities.EntitiesConfiguration;
using CanariasBlog.Areas.BasicCore.Entities.EntitiesConfiguration;

namespace CanariasBlog.Areas.BasicCore.Entities.Configuration
{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            try
            {
                ...
                string ConnectionStringProduction = "Password=5wn9IyD)t3ZL-4;" +
                    ...
                    "Initial Catalog=fiyista1_CanariasBlog;" +
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            try
            {
                ...
                modelBuilder.Entity<Menu>().HasData(new Menu
                {
                    ...
                    MenuFatherId = 15,
                    Order = 0,
                    URLPath = "/CanariasBlog/BlogPostPage",
                    IconURLPath = "",
                    Active = true,
                    DateTimeCreation = DateTime.Now,
                    DateTimeLastModification = DateTime.Now,
                ...
                modelBuilder.Entity<Menu>().HasData(new Menu
                {
                    ...
                    MenuFatherId = 15,
                    Order = 0,
                    URLPath = "/CanariasBlog/UserProfilePage",
                    IconURLPath = "",
                    Active = true,
                    DateTimeCreation = DateTime.Now,
                    DateTimeLastModification = DateTime.Now,
                ...
                modelBuilder.Entity<Menu>().HasData(new Menu
                {
                    ...
                    MenuFatherId = 15,
                    Order = 0,
                    URLPath = "/CanariasBlog/AgendaPage",
                    IconURLPath = "",
                    Active = true,
                    DateTimeCreation = DateTime.Now,
                    DateTimeLastModification = DateTime.Now,
                ...
                modelBuilder.Entity<Menu>().HasData(new Menu
                {
                    ...
                    MenuFatherId = 15,
                    Order = 0,
                    URLPath = "/CanariasBlog/CarouselTemasDeInteresPage",
                    IconURLPath = "",
                    Active = true,
                    DateTimeCreation = DateTime.Now,
                    DateTimeLastModification = DateTime.Now,
                ...
                modelBuilder.Entity<Menu>().HasData(new Menu
                {
                    ...
                    MenuFatherId = 15,
                    Order = 0,
                    URLPath = "/CanariasBlog/MarketplacePostServicePage",
                    IconURLPath = "",
                    Active = true,
                    DateTimeCreation = DateTime.Now,
                    DateTimeLastModification = DateTime.Now,
